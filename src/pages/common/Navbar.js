...
const Navbar=()=>{
    ...
    return (
        <div className="w-full lg:w-3/4 mx-auto">
            <div className="w-full lg:flex h-12  justify-between">
                <div>
                 <p className="text-center lg:text-start text-gray-500 font-semibold text-sm mt-2">Free shipping for standing over 5k order</p>
                </div>
                <div className="flex gap-8 text-center pl-16 lg:pl-0">
                 <p className=" text-gray-500 font-semibold text-sm mt-2">Help & FAQS</p>
                 <Link to="/user/login">
                 <p className="text-gray-500 font-semibold text-sm mt-2">Login </p>
                 </Link>
                 <Link to="/user/register">
                 <p className="text-gray-500 font-semibold text-sm mt-2">Register</p>
                 </Link>
                </div>
            </div>
            <header className="mt-4">
                <nav className="flex items-center justify-between pr-3 lg:py-4 lg:pr-0" aria-label="Global">
                    ...
                    <div className="hidden lg:flex gap-12 lg:flex-1 lg:justify-end">
                        ...
                        <div className="flex ">
                            <Link to="/cart">
                            <AiOutlineShoppingCart className="text-xl"></AiOutlineShoppingCart></Link>
